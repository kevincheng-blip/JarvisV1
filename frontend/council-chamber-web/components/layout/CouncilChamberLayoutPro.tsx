...
import { RoleGrid } from "../council-chamber/RoleGrid";
import { StatusBar } from "../council-chamber/StatusBar";
...
import { CouncilChamberSessionState, ProviderKey } from "@/lib/types/councilChamber";
import { WebSocketStatus } from "@/lib/ws/councilChamberClientPro";
import { Quote } from "@/lib/types/quotes";

interface CouncilChamberLayoutProProps {
...
export function CouncilChamberLayoutPro({ 
  state, 
  onStart, 
  wsStatus = "disconnected",
  quotes = [],
  onSelectSymbol,
}: CouncilChamberLayoutProProps) {
    ...
    <div className="min-h-screen bg-ultra-dark text-foreground">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground tracking-wide">
              <span className="bg-gradient-to-r from-ai-blue via-military-green to-metal-gold bg-clip-text text-transparent">
                J-GOD Multi-AI AI Council Chamber v6 PRO
              </span>
            </h1>
            <p className="text-xs text-gray-500 mt-1">AI Council Chamber - Professional Multi-AI Collaboration</p>
          </div>
      ...
      <div className="container mx-auto px-6 py-6">
        <div className="grid grid-cols-12 gap-6">
          ...
          {/* Right: AI Council Chamber (75%) */}
          <div className="col-span-12 lg:col-span-9">
            <div className="grid grid-cols-12 gap-6">
              {/* Main AI Council Chamber Content (75%) */}
