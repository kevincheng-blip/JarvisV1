...
import { EventTimeline } from "../council-chamber/EventTimeline";
import { MissionSummary } from "../council-chamber/MissionSummary";
...
export function CouncilChamberLayout({ state, onStart, isReconnecting = false }: CouncilChamberLayoutProps) {
