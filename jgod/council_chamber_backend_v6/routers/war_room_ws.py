"""
AI Council Chamber WebSocket 路由 - v6.0
提供 WebSocket API 供 Next.js 前端訂閱幕僚會議室事件流
"""
import uuid
import asyncio
import logging
...
async def create_session(
    ...
    """
    建立新的幕僚會議室 Session（需要 API Key 和 Rate Limit 檢查）
...
async def war_room_websocket(
    ...
    """
    AI Council Chamber WebSocket 端點（需要 API Key 和 Rate Limit 檢查）
