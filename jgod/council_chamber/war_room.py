...
詳見 spec/JGOD_Python_Interface_Spec.md 的 AI Council Chamber / AI Council 章節。
...
class CouncilMember(ABC):
    ...
    對應概念：幕僚會議室幕僚團（量化總監、風控長、盤勢分析官、情報官、策略顧問、商業顧問）
    """
...
class WarRoom:
    """AI 幕僚會議室（AI Council Chamber / AI Council）
    
    詳見 spec/JGOD_Python_Interface_Spec.md 的 WarRoom 章節。
    對應文件：J-GOD 股市聖經系統1_AI知識庫版_v1_CORRECTED.md
    對應概念：AI 幕僚會議室（多 AI 幕僚團 + GPT 總結）
    ...
    def run_council(self,
        ...
        對應文件：J-GOD 股市聖經系統1_AI知識庫版_v1_CORRECTED.md
        對應概念：多 AI 幕僚會議室 - 各幕僚基於 J-GOD 數據給意見，最後「總架構師人格」幫你彙整成結論
        """
        pass
