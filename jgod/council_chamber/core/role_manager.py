...
from jgod.council_chamber.core.async_dispatcher import AsyncDispatcher
...
class RoleManager:
    ...
    # 角色系統提示
    ROLE_SYSTEM_PROMPTS = {
        "Intel Officer": "你是 J-GOD 幕僚會議室的情報官（Intel Officer），負責蒐集與整理市場資訊。",
        "Scout": "你是 J-GOD 幕僚會議室的偵察兵（Scout），負責快速摘要與輔助分析。",
        "Risk Officer": "你是 J-GOD 幕僚會議室的風險官（Risk Officer），負責評估風險與提供風險建議。",
        "Quant Lead": "你是 J-GOD 幕僚會議室的量化主管（Quant Lead），負責技術分析與量化策略。",
        "Strategist": "你是 J-GOD 幕僚會議室的策略師（Strategist），負責統整所有意見並給出最終建議。",
    }
