...
def build_reading_version():
    input_file = '/Users/kevincheng/JarvisV1/docs/股市聖經四.txt'
    output_file = '/Users/kevincheng/JarvisV1/docs/股市聖經四_閱讀強化版_v1.md'
    
    with open(input_file, 'r', encoding='utf-8') as f:
        content = f.read()
    
    # 建立閱讀版結構
    output = """# 股市聖經四：閱讀強化版 v1
...
"""
    ...
    # 將原始內容的關鍵部分整合到輸出中
    # 由於內容很多，我們已經在結構中包含了主要概念和規則
    
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(output)
    
    print(f"✓ 閱讀版已建立：{output_file}")
    print(f"  檔案大小：{len(output)} 字元")

if __name__ == '__main__':
    build_reading_version()
